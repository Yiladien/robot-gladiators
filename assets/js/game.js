...
// function to end the entire game
  var endGame = function() {
    ...
    prevHighScorePlayer = localStorage.getItem("highScorePlayer");

    if (!prevHighScore) {
      prevHighScore = "0";
      prevHighScorePlayer = "no one"
    }

    if (playerInfo.money < prevHighScore) {
      window.alert("You did not beat the previous high score of " + prevHighScore + " set by robot " + prevHighScorePlayer + ".");
    } else {
      localStorage.setItem("highScore", playerInfo.money);
      localStorage.setItem("highScorePlayer", playerInfo.name);
      window.alert("You set a new high score with " + playerInfo.money + "! Previous high score was " + prevHighScore + " set by robot " + prevHighScorePlayer + ".");  
    }
